  ...
  return (
    <div className="w-full max-w-[1139px] bg-white rounded-[8px] border border-[#1B7F88] p-[24px] flex flex-col gap-6 animate-in fade-in duration-200">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-[18px] font-medium font-inter text-[#1B2B2E]">Current Medications</h2>
      </div>

      <div className="flex flex-col gap-4">
        <p className="text-[#8FA1A6] font-inter">Add your current medications details here.</p>
